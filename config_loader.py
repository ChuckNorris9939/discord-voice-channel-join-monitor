...
DB_KEY_TESTING_MODE_ID = "TESTING_MODE_ID"
...
def load_all_settings():
    global AFK_TIMER_MINUTES, TESTING, BOT_LOGS_ID, GARMIN_AUTO_JOIN_CHANNELS, GARMIN_AUTO_JOIN_ENABLED, GARMIN_MAX_RECORDING_DURATION, GARMIN_RECORD_SECONDS, GARMIN_STT_OUTPUT_ENABLED, HIDDEN_CHANNELS, JOIN_MESSAGE_TIMER_ENABLED, JOIN_MESSAGE_TIMER_MINUTES, JOIN_LOGS_ID, LOG_LEVEL, DISCORD_LOG_LEVEL, PURGE_OLDER_THAN_DAYS, STT_ENABLED, STT_ENGINE, TECHSUPPORT_CHANNEL_ID, VOSK_MODEL_PATH, AFK_CHANNEL_ID, CLEANUP_ALIGNED_RECORDINGS_HOURS, CLEANUP_GARMIN_OUTPUT_HOURS, TESTING_MODE_ID
    ...
    TESTING_MODE_ID = load_channel_id(DB_KEY_TESTING_MODE_ID, DEFAULT_TESTING_MODE_ID)
