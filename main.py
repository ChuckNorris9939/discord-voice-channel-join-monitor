...
def settings_route():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            save_setting(DB_KEY_TEMP_DAVE_FIX, request.form.get('temp_dave_fix', 'false'))
    ...
    current_settings_display['TEMP_DAVE_FIX'] = str(cfg.TEMP_DAVE_FIX).lower()
